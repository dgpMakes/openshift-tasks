...
public interface StoreApi {
    ...
    ResponseEntity<Order> getOrderById(@Min(1L) @Max(10L) @ApiParam(value = "ID of trip that needs to be fetched",required=true) @PathVariable("orderId") Long orderId);


    @ApiOperation(value = "Place an order for a trip", nickname = "placeOrder", notes = "", response = Order.class, tags={ "store", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = Order.class),
    ...
    ResponseEntity<Order> placeOrder(@ApiParam(value = "order placed for booking the trip" ,required=true )  @Valid @RequestBody Order body);
